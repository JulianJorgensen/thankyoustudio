...
export default (props) => (
  ...
  >
    ...
    <Grid ratio="16x9">
      <Image lazy delay={200} src="http://cdn.thankyoustudio.com.s3.amazonaws.com/cases/onea/images/onea-dark.jpg" />
    </Grid>

    <Grid cols="2" ratio="1x1">
      <Image lazy delay={200} src="http://cdn.thankyoustudio.com.s3.amazonaws.com/cases/onea/images/onea-02.jpg" />
      <Image lazy delay={200} src="http://cdn.thankyoustudio.com.s3.amazonaws.com/cases/onea/images/onea-cylinder.jpg" />
    </Grid>

    <Grid cols="2" ratio="2x3">
      <Image lazy delay={200} bgColor="white" inline src="http://cdn.thankyoustudio.com.s3.amazonaws.com/cases/onea/images/onea-logo.jpg" />
      <Image lazy delay={200} src="http://cdn.thankyoustudio.com.s3.amazonaws.com/cases/onea/images/onea-standing-light.jpg" />
    </Grid>
    ...
    <Grid cols="2" ratio="1x1">
      <Image lazy delay={200} src="http://cdn.thankyoustudio.com.s3.amazonaws.com/cases/onea/images/onea-gradient-dark.jpg" />
      <Image lazy delay={200} src="http://cdn.thankyoustudio.com.s3.amazonaws.com/cases/onea/images/onea-gradient-light.jpg" />
    </Grid>
    ...
    <Grid ratio="16x9">
      <Image lazy delay={200} src="http://cdn.thankyoustudio.com.s3.amazonaws.com/cases/onea/images/onea-storm-long.jpg" />
    </Grid>

    <Grid cols="2" ratio="2x3">
      <Image lazy delay={200} src="http://cdn.thankyoustudio.com.s3.amazonaws.com/cases/onea/images/onea-storm-base-tube.jpg" />
      <Image lazy delay={200} src="http://cdn.thankyoustudio.com.s3.amazonaws.com/cases/onea/images/onea-lightning-table.jpg" />
    </Grid>
